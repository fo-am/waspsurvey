...
class Question(models.Model):
    ...
    INSECT_WASP_BEE = "insect-wasp-bee"
    INFO = "info"
    ...
    QUESTION_TYPES = (
        ...
        (INSECT_WASP_BEE, _("Insect wasp/bee")),
        (INFO, _("Information")),
    )
    ...
    HIDE_FARMER = "hide-farmer"
    HIDE_NOT_FARMER = "hide-not-farmer"
    ...
    QUESTION_CODES = (
        ...
        (USER_FARMER, _("User farmer question")),
        (HIDE_NOT_FARMER, _("Hide if not farmer")),
        (HIDE_FARMER, _("Hide if farmer")),
    )
    ...
    code = models.CharField(_("Use for"), max_length=200, choices=QUESTION_CODES, default=DEFAULT)
